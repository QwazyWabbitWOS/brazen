...
void Calc_Arc(edict_t* ent)
{
	...
	move[0] = fmodf((move[0] + 180), 360) - 180;
	move[1] = fmodf((move[1] + 180), 360) - 180;
	move[2] = fmodf((move[2] + 180), 360) - 180;
	VectorScale(move, (int)1 / FRAMETIME, ent->avelocity);
}
